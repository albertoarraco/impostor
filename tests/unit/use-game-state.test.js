...
vi.mock("../../src/hooks/game/use-game-config-state", () => {
  const state = {
    step: "home",
    configTab: "game",
    names: ["A"],
...
vi.mock("../../src/hooks/game/use-game-derived", () => ({
  default: () => ({
    canStart: true,
    cleanNames: ["A"],
    baseLabels: [],
...
vi.mock("../../src/hooks/game/use-game-persistence", () => ({
  default: () => ({
    history: [],
    setHistory: vi.fn(),
...
vi.mock("../../src/hooks/game/use-game-logic", () => ({
  default: () => ({
    started: false,
    roles: [],
    revealed: false,
